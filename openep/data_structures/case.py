...
class Case:
    ...
    def load_unipolar_electrograms(
        self,
        filename,
        return_bipolar=True,
        return_annotations=True,
        ):
        """Load unipolar electrograms into the Case object.

        The unipolar electrograms and associated data (voltages, names, points)
        are modified in-place.

        Args:
            filename (str): Path to file containing the unipolar electrograms.
            return_bipolar (bool): If True, bipolar electrograms and associated data
                (voltages, names, points) will be determined from the unipolar
                electrograms and returned.
            return_annotations (bool): If True, default annotations of the electrograms will
                ...
                annotations will all be set to 0 ms. The local activation times will
                be empty.

        Returns:
            unipolar_egm (Electrogram): unipolar electrgorams and their associated data
                (voltages, names, points).
            bipolar_egm (Electrogram, optional): bipolar electrgorams and their associated
                data (voltages, names, points).
            annotations (Annotations, optional): default annotations of the electrograms
                will also be returned.

        Warning
        -------
        Currently, only unipolar electrograms generated by openCARP can be loaded.
        """
        ...
        if not return_bipolar and not return_annotations:
            return unipolar_egm

        return_items = []
        return_items.append(unipolar_egm)
        ...
        if return_bipolar:
            ...
            return_items.append(bipolar_egm)
        ...
        if return_annotations:
            ...
            return_items.append(annotations)
